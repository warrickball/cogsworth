...
def integrate_orbits_with_events_batch(task):
    """Integrate a batch of :class:`~gala.dynamics.PhaseSpacePosition` with events
    ...
    task : `tuple`
        ...
        `w0`, `t1`, `t2`, `dt`, `events`, `potential`, `store_all`, `quiet`
